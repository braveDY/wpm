...
All the environments are registered in the `wmp` extension. They start
...
def main():
    ...
    for task_spec in gym.registry.values():
        if "Wmp" in task_spec.id and (args_cli.keyword is None or args_cli.keyword in task_spec.id):
